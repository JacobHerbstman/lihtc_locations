...
The project is currently in its design and source-validation stage. The first
empirical milestone is a national project-by-tract panel that distinguishes
within-municipality sorting from differences across municipalities.
...
Later production tasks will be added only when they have defined inputs,
