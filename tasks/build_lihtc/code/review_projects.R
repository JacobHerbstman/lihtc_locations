...
review <- x[review_needed==TRUE,.(hud_id,project_name,address_key,street,city,state,pis_year,total_units,
  ...
  exclusion_reason,confident_first,location_status,matched_address,hud_latitude,hud_longitude,census_latitude,census_longitude,hud_census_distance_m)]
SaveData(review,"../output/review.csv","../report/review.txt","hud_id")
